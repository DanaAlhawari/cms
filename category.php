<?php
/* Template Name: restaurang category*/
?>
<?php
get_header();?>
...
$args= array('post_type'=>'post',
          'category_name'=>'restauranger-i-stockholm',
          'category_name'=>'restauranger-i-goteborg',
    ...
    if($query->have_posts()):
        ...
        <div class="flex-article-container">           
                ...
                <div class="article_info">
                    <h2><a href="<?php the_permalink(); ?>"><?php the_field('title');?></a></h2><hr>                           
                        <b>Mat:</b>
                        <?php the_field('mat');?><br>
                        <b>Webbplats:</b>
